...
function getStandaloneComponentsInfo(tree, projectPath) {
    ...
    (0, devkit_1.visitNotIgnoredFiles)(tree, projectPath, (filePath) => {
        ...
        standaloneComponents.forEach((componentName) => {
            componentsInfo.push({
                componentFileName: (0, path_1.basename)(filePath, '.ts'),
                moduleFolderPath: projectPath,
                name: componentName,
                path: (0, path_1.dirname)((0, path_1.relative)(projectPath, filePath)),
            });
        });
    });
    return componentsInfo;
